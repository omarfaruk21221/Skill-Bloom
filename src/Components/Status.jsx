...
const Status = () => {
  return (
    <>
      <section className="card col-span-12 md:col-span-6 lg:col-span-3 w-60 h-40 mx-auto pt-6 bg-base-100 text-purple-600 shadow-2xl text-center space-y-1 hover:bg-secondary hover:text-green-300 hover:scale-110 transform ease-in-out">
